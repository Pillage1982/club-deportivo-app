...
//
// Sin puntaje en esta rama (específico de cliente/calamena), y `personas` no
// tiene bloque/sexo/dirección/fecha de ingreso, así que Mi Ficha muestra solo
// lo que existe. La deuda SÍ incluye multas aquí (a diferencia de calamena),
// por eso Finanzas muestra también una tabla de multas.
  ...
  fetch(`${API_URL}/socio-auth/mi-ficha`, { headers: getAuthHeadersSocio() })
    ...
    .then(ficha => {
      ...
      document.getElementById('ficha_datos').innerHTML = `
        ...
        ${filaFicha('Email', escaparHtml(ficha.email || '—'))}
