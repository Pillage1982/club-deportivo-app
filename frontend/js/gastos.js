// Interfaz de gastos: formulario, filtros, comprobantes, tabla y eliminación.
let gastosCargados = [];
...
function crearGasto() {
  ...
  if (!archivo) {
    mostrarAlerta(
      'Se guardará sin comprobante adjunto. Se recomienda adjuntar la boleta/factura para respaldo ante la asamblea.',
      'warning'
    );
  }
